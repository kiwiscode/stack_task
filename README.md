# <div style="display: flex; align-items: center; gap: 10px;"><img src="./client/public/images/stack_task_logo.png" alt="Project Logo" height="33.5px"><h1>Stack Task</h1></div>
